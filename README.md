...
```
$ docker run -t -i --rm --name feeder --net host pipe-to-elasticsearch-worker -en 172.16.100.62 -i kafka3 -p /tmp/fifo -n 300000 -nt 4 -s 99 -f 180000 -ki kafka01 -kp 6667 -t toprocess -g elasticsearch -c
```
